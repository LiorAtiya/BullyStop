            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 py-10 px-6 dark:bg-dark sm:p-[60px]">
                ...
                <form>
                  ...
                  :בחר מה אתה
                  <br></br><br></br>
                  <div className="flex mb-8 text-right">
                    <span>
                       הורה
                    </span>
                    <label
                      htmlFor="checkboxLabel"
                      className="flex text-sm font-medium text-right cursor-pointer select-none text-body-color"
                    >
                      <div className="relative">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className="flex items-center justify-center w-5 h-5 mt-1 mr-4 border rounded box border-body-color border-opacity-20 dark:border-white dark:border-opacity-10">
